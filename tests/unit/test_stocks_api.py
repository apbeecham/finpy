...
class TestStocksApi(unittest.TestCase):
    ...
    def test_get_intraday_with_invalid_params(self):
        ...
        with self.assertRaises(ValueError):
            self.client.get_intraday_data('MSFT', interval='2min')
        with self.assertRaises(ValueError):
            self.client.get_intraday_data('MSFT', output_size='big')
        with self.assertRaises(ValueError):
            self.client.get_intraday_data('MSFT', data_type='xml')
    ...
    def test_get_daily_with_invalid_params(self):
        ...
        with self.assertRaises(ValueError):
            self.client.get_daily_data('MSFT', output_size='big')
        with self.assertRaises(ValueError):
            self.client.get_daily_data('MSFT', data_type='xml')
    ...
    def test_get_daily_adjusted_with_invalid_params(self):
        ...
        with self.assertRaises(ValueError):
            self.client.get_daily_adjusted_data('MSFT', output_size='big')
        with self.assertRaises(ValueError):
            self.client.get_daily_adjusted_data('MSFT', data_type='xml')
